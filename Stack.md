...
Real-world analogy:
A stack of books — you place books on top and remove them from the top.

🔹 Core Characteristics
➤ Data Representation

A stack can store homogeneous (same type) or heterogeneous (different types) data.
...
Stack operations are very fast and efficient for specific algorithms.
...
isFull	Checks whether the stack is full (array-based stack)
⏱ Time Complexity
